...
import {
  AdminPageHeader, AdminCard, AdminTable, Field, Input, TextArea, Select, Checkbox, FileInput,
...
export default function AdminProductsPage(): ReactElement {
  ...
  return (
    <div>
      ...
      {showForm && (
        <AdminCard className="mb-6">
          <h3 className="mb-5 text-lg font-bold text-white">{editId ? "✏️ Sửa sản phẩm" : "➕ Thêm sản phẩm"}</h3>
